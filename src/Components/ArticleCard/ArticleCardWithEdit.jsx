...
export default function ArticleCardWithEdit(props) {
                        ...
                        <div className="flex items-center">
                            ...
                            >
                                <button className="btn btn-warning">
                                    <i className="fa fa-edit" aria-hidden="true" /> Edit this article
                                </button>
                            </Popconfirm>
                            <Popconfirm
                            ...
                            >
                                <button className="btn btn-warning ml-2">
                                    <i className="fa fa-download" aria-hidden="true" /> Download this article
                                </button>
                            </Popconfirm>
                        </div>
                    </div>
