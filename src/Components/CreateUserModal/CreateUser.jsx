            ...
            (<div className='w-full h-full' style={{
                ...
                <div className='p-5' style={{
                    ...
                    <form onSubmit={handleOnSubmit}>
                        ...
                        <div className='form-group mb-3'>
                            <label htmlFor='retype_password' className=''>Retype Password</label>
                            <input
                                className='form-control'
                                type='password'
                                id='retype_password'
                        ...
                        <div className='flex justify-end'>
                            ...
                            <button type='button' className='btn btn-danger' onClick={() => dispatch(setModalOpen(false))}>Cancel</button>
                        </div>
                    </form>
                </div>
            </div>) : null
