...
import { getArticlesByFacultyIdAndAcademicYearId, getArticlesByUserId } from '../../Redux/reducers/articleReducer';
        ...
        <div>
            ...
            >
                            ...
                            <li className="nav-item" role="presentation">
                                <button
                                    onClick={(e) => {
                                        ...
                                        dispatch(getArticlesByFacultyIdAndAcademicYearId({
                                            faculty_id: 1,
                                            academic_year_id: 0
                                        }))
                                    }}
                                    className="nav-link active"
                                    id="computing-tab" data-bs-toggle="tab"
                ...
                <div className="tab-content">
                    <div className="bg-[#235895] tab-pane active" id="computing" role="tabpanel" aria-labelledby="computing-tab">
                    ...
                    <div className="bg-[#235895] tab-pane" id="business" role="tabpanel" aria-labelledby="business-tab">
                        {articleList?.map((article, index) => {
                            return (
                                <ArticleCard article={article} index={index} articleList={articleList} />
                            );
                    ...
                    <div className="bg-[#235895] tab-pane" id="design" role="tabpanel" aria-labelledby="design-tab">
                        {articleList?.map((article, index) => {
                            return (
                                <ArticleCard article={article} index={index} articleList={articleList} />
                            );
