...
export default function YourArticle(props) {
  ...
  const acceptedArticles = filterArticleByStatus(
    articleListByUserId,
    "accepted"
  );
  const pendingArticles = filterArticleByStatus(articleListByUserId, "pending");
  const rejectedArticles = filterArticleByStatus(
    articleListByUserId,
    "rejected"
  );
        ...
        <div className="tab-content">
          <div className="container-fluid text-end">
            <button
              ...
              className="font-medium btn btn-link"
            >
